                        ...
                        <div class="card h-100 shadow-sm">
                            <div class="card-body d-flex flex-column">
                                ...
                                <ul class="list-unstyled mb-3">
                                    <li><i class="fas fa-fire text-primary"></i> Kalori terbakar:
                                        {{ $activity->calories_burned }} per jam</li>
                                    <li><i class="fas fa-chart-line text-primary"></i> Intensitas:
                                        {{ $activity->intensity_level }}</li>
                                </ul>
                                <a href="{{ route('user.exercise.start', $activity->id) }}"
                                    class="btn btn-outline-primary mt-auto">Mulai Program</a>
                            </div>
                        </div>
                    </div>
                @empty
